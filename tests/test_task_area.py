...
def test_add_task_with_unknown_area_rejected(tm_epic_phase):
    out = backlog_add_task(
        title="Do a thing", epic="test-epic", phase="dev", area="ghost-area",
    )
...
def test_add_task_with_known_area_accepted(tm_epic_phase):
    ...
    out = backlog_add_task(
        title="Do a thing", epic="test-epic", phase="dev", area="desktop-app",
    )
...
def test_list_tasks_filters_by_area(tm_epic_phase):
    backlog_area_create(area_id="desktop-app", name="Desktop App")
    backlog_area_create(area_id="viewer", name="Viewer")
    out1 = backlog_add_task(title="Desktop task", epic="test-epic", phase="dev", area="desktop-app")
    out2 = backlog_add_task(title="Viewer task", epic="test-epic", phase="dev", area="viewer")
    tid1 = out1.split("`")[1]
    tid2 = out2.split("`")[1]
