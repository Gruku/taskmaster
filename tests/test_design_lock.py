...
def test_design_change_blocked_when_locked(tm_epic_phase):
    ...
    backlog_add_task(epic="test-epic", title="redesign cache", phase="dev", options={"task_id": "D-1"})
...
def test_design_change_allowed_when_revising(tm_epic_phase):
    ...
    backlog_add_task(epic="test-epic", title="redesign", phase="dev", options={"task_id": "D-2"})
...
def test_design_change_clear(tm_epic_phase):
    backlog_add_task(epic="test-epic", title="x", phase="dev", options={"task_id": "D-3"})
...
def test_design_change_allowed_when_no_design_status(tm_epic_phase):
    ...
    backlog_add_task(epic="test-epic", title="x", phase="dev", options={"task_id": "D-4"})
...
def test_design_change_allowed_when_proposed(tm_epic_phase):
    ...
    backlog_add_task(epic="test-epic", title="x", phase="dev", options={"task_id": "D-5"})
