...
|---|---|---|---|---|---|---|---|
| MCP server (`backlog_*` tools) | 1 | ✅ `.mcp.json` | ✅ `.mcp.json` | pending (Phase 3) | pending (Phase 4) | pending (Phase 4) | pending (Phase 4) |
| `.taskmaster/` on-disk format | 1 | ✅ | ✅ | ✅ (file-based, assistant-independent) | ✅ | ✅ | ✅ |
| Viewer (kanban web UI) | 1 | ✅ | ✅ | ✅ (assistant-independent) | ✅ | ✅ | ✅ |
| Project manifest (`project.py`) | 1 | ✅ | ✅ | pending (Phase 3) | pending (Phase 4) | pending (Phase 4) | pending (Phase 4) |
| Workflow playbooks (`playbooks/`) | 2 | ✅ via `skills/` wrappers | ✅ via `skills/` wrappers | pending — `adapters/codex/` (Phase 3) | pending — `adapters/agents-md/` (Phase 4) | pending (Phase 4) | pending (Phase 4) |
