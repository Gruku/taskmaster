...
|---|---|---|---|---|---|---|---|
| MCP server (`backlog_*` tools) | 1 | ✅ `.mcp.json` | ✅ `.mcp.json` | ✅ verified 2026-07-08 (`adapters/codex/config.toml`, codex 0.130.0) | configured (`~/.cursor/mcp.json`); GUI verify pending | not installed locally — untested | ✅ verified 2026-07-08 (`opencode.json` mcp.local, opencode 1.17.14) |
